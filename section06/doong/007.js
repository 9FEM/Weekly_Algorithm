...
const E = "DEF";
const F = "FEDABC";
console.log(solution(E, F)); // NO

// 접근 방법
// 1. 필수과목 순서가 문자열로 입력되기 때문에 배열로 변경한다. (split("") || Array.from() || spread연산자)
// 2. plan에 대한 for문을 돌면서 필수과목인 수업인지 확인
// 3. 필수과목인 수업에 해당한다면, 주어진 필수과목 순서 중 첫번째 순서인 과목과 같은지 비교
// 4. 수업 계획에 필수 과목이 포함되지 않는 경우도 있기 때문에 for문이 끝나면 배열에 값이 남아있는지 확인